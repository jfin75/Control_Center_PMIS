...
import { Building2, CornerDownLeft, FileCheck2, FileText, FolderKanban, Gavel, Hash, Lightbulb, MessageCircleQuestionMark, Search, Users } from "lucide-react";
...
const KIND_ORDER: SearchKind[] = ["Page", "Project", "Property", "Cost code", "Contractor", "Bid package", "Planning request", "Submittal", "RFI"];
