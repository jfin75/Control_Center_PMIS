...
An Owner-focused PMIS for a capital program: Portfolio, Dashboard, Planning, Projects, Workload, Bidding, Submittals, RFIs, Contracts, Cost, Reports, Time Tracking, and Settings. It's one static Next.js build that ships to **Vercel** and runs as a **Tauri** desktop app on macOS and Windows.
